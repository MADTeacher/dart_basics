...
void main() async {
  ...
  // Чистый SQL-запрос
  var query = 'DELETE FROM student WHERE full_name = "Мартынов Сергей Иванович"';
  await db.execute(query);

  // Аналогичный запрос средствами sqflite
  db.delete('student', where: 'full_name = "Андреева Анна Валерьевна"');

  print('Список студентов:');
  // Выводим ФИО и имя группы
  query = 'SELECT student.full_name, student_group.name as group_name FROM student ';
