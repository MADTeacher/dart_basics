...
void main() async {
  sqfliteFfiInit();
  // Поэтапная миграция базы данных с версии 1 на версию 3
  print('Миграция базы данных с версии 1 на версию 2');
  await openAndPrintDatabase('myDb.db', 2);
  print('--------------------------------');

  print('Миграция базы данных с версии 2 на версию 3');
  await openAndPrintDatabase('myDb.db', 3);
  print('--------------------------------');

  // Поэтапный откат миграции до версии схемы с версией 1
  print('Миграция базы данных с версии 3 на версию 2');
  await openAndPrintDatabase('myDb.db', 2);
  print('--------------------------------');

  print('Миграция базы данных с версии 2 на версию 1');
