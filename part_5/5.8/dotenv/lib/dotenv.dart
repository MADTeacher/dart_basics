...
// Создание глобального экземпляра DotEnv и загрузка переменных окружения
final env = DotEnv(platformEnv: false)..load();

/// Класс для работы с переменными окружения из .env файлов
final class DotEnv {
